...
export default function LearningPlayer() {
  ...
  return (
    ...
    <header className="flex min-h-16 items-center justify-between gap-4 border-b border-white/10 bg-[#101318] px-4 py-3 lg:px-8"><div className="flex min-w-0 items-center gap-4"><Link href="/profile?tab=learning" className="text-xl font-black tracking-[-0.06em] text-white">Coding World</Link><span className="hidden h-6 w-px bg-white/20 sm:block" /><span className="hidden truncate text-sm text-slate-300 sm:block">React.js Complete Course</span></div><div className="flex items-center gap-4 text-sm"><span className="hidden text-slate-400 md:inline">{progress}% complete</span><Link href="/profile?tab=learning" className="rounded-md border border-white/20 px-3 py-2 font-semibold text-slate-200 transition hover:border-white/50 hover:text-white">Exit course</Link></div></header>
